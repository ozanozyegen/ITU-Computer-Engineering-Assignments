...
int main()
{
	...
	/* 	First create/allocate two arrays to contain your original and encoded data.
		Determine the length of the data you wish to encode. Pass the input data, the array to contain the output, and the length of the data as arguments to the base64_encode() function.
		When you wish to decode the data, use the base64_decode() function. It works the same way, except the data gets decoded.*/
